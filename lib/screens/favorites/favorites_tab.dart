...
class _FavoritesTabState extends State<FavoritesTab> {
          ...
          children: [
                ...
                children: [
                  StreamBuilder<UserModel?>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Text(
                        firstName.isNotEmpty ? "Hi, $firstName" : "Favorites",
            ...
            Expanded(
              child: StreamBuilder<Set<String>>(
                ...
                builder: (context, favIdsSnap) {
                  if (favIdsSnap.connectionState == ConnectionState.waiting) {
                    return const Center(child: CircularProgressIndicator());
                  }

                  final favIds = favIdsSnap.data ?? {};
                  ...
                  return StreamBuilder<List<PuppyPost>>(
                    stream: FirebaseService.globalFeedStream(''), // Stream all posts to match favorites
                    builder: (context, allPostsSnap) {
                      final allPosts = allPostsSnap.data ?? [];
                      final favoritedPosts = allPosts.where((post) => favIds.contains(post.id)).toList();
                      final filtered = _applyFilters(favoritedPosts);
                      ...
                      return GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildFavoriteCard(context, post);
                        },
                      );
                    },
                  );
  ...
  Widget _buildFavoriteCard(BuildContext context, PuppyPost post) {
